...
export default class PingCommand extends SlashCommand {
	...
	public async run(
		...
		return interaction.editReply({
			content:
				`${emojis.icons_pong} ${emojis.icons_text5} **Pong!** ${interaction.user}, veja **logo abaixo** minha **latência**: ` +
				...
				`\n> - ${emojis.icons_cmd} ${emojis.icons_text6} **Environment**: \`${bot.environment}\``,
		});
	}
}
